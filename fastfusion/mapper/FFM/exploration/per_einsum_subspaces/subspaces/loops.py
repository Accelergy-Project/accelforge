...
from fastfusion.mapper.FFM.exploration.constraints import PerEinsumDataflowConstraint, WILDCARD
from fastfusion.mapper.FFM.exploration.per_einsum_subspaces.subspaces.linear_mapping import LinearMapping
