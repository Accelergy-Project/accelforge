...
attribute to one of the :py:class:`~accelforge.mapper.FFM.Metrics` enum values or a
...
:py:func:`~accelforge.mapper.FFM.main.make_pmappings` function. This function returns a
:py:class:`~accelforge.mapper.FFM.main.MultiEinsumPmappings` object, which contains all
...
To help with debugging, the :py:func:`~accelforge.mapper.FFM.main.make_pmappings`
...
:py:class:`~accelforge.mapper.FFM.pmappings.MultiEinsumPmappings` object has additional
...
The :py:class:`~accelforge.mapper.FFM.mappings.Mappings` object includes stats for the
mappings that were found, including, for each pmapping, resource usage and objective
metrics.

To access the stats, we can use the :py:meth:`~accelforge.mapper.FFM.mappings.Mappings.access`
method, which will return a :py:class:`~accelforge.mapper.FFM.mappings.Mappings` object
...
:py:meth:`~accelforge.mapper.FFM.mappings.Mappings.render` method, which will return a
